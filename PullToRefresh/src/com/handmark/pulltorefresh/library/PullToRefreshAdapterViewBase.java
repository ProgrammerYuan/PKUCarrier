...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private boolean isLastItemVisible() {
		final Adapter adapter = mRefreshableView.getAdapter();
//		Log.d(LOG_TAG,"COUNT:" + adapter.getCount() + "/" + mRefreshableView.getCount());
		if (!refreshableHasHeader && (null == adapter || adapter.isEmpty())) {
			if (DEBUG) {
...
//					Log.d(LOG_TAG,lastVisibleChild.getHeight() + "/" + lastVisibleChild.getTop() + "/" + lastVisibleChild.getBottom() + "/" + mRefreshableView.getBottom());
