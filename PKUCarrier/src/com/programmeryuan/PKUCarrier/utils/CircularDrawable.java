...
public class CircularDrawable extends Drawable {
	 ...
	 */
	CircularDrawable(int ringWidth, float circleScale, int outlineColor, int ringColor, int centerColor) {
		this.progress = 0;
	...
	public void draw(Canvas canvas) {
		...
		canvas.drawCircle(bounds.centerX(), bounds.centerY(), size, paint);
		...
		float arcX0 = offsetX + 1;
		float arcY0 = offsetY + 1;
		float arcX = offsetX + outerRadius * 2 - 1;
		float arcY = offsetY + outerRadius * 2 - 1;
	...
	public static class Builder {
		...
		public CircularDrawable create() {
			return new CircularDrawable(ringWidth, circleScale, outlineColor, ringColor, centerColor);
		}
